    ...
    for (var di in input.data) {
      ...
      if (data['sub'] === 'nlp' && data['intent']['service'] === 'OS6981162467.CreateGuide' && data['intent']['intentType'] === 'custom' && data['intent']['shouldEndSession']) {
        ...
        for (var sei in semantics) {
          ...
          if (semantic['intent'] === 'ActivityGuide' || semantic['intent'] === 'InputDatetime' || semantic['intent'] === 'InputSomething' || semantic['intent'] === 'InputAddress' || semantic['intent'] === 'InputMember' || semantic['intent'] === 'EndGuide') {
            return true;
          }
        }
      }

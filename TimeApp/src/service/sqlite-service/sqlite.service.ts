...
isMobile():boolean{
  ...
  test(){
      let sqlStr = "INSERT INTO GTD_D(playersId,scheduleOtherName,playersFinishDate,userId) " +
        "VALUES ('24314','12424','2108-11-18 20:12','123458');"+
        "INSERT INTO GTD_D(playersId,scheduleOtherName,playersFinishDate,userId) " +
        "VALUES ('243142','12424','2108-11-19 07:12','123458');" +
        "INSERT INTO GTD_D(playersId,scheduleOtherName,playersFinishDate,userId) " +
        "VALUES ('243141','12424','2108-11-28 08:12','123458');"
    this.sqlitePorter.importSqlToDb(this.database,sqlStr).then(data=>{
        console.log(data)
    }).catch(e=>{
      console.log(e)
    })
    ...
    // "VALUES ('243142','12424','2108-11-19 07:12','123458');" +
    //   "INSERT INTO GTD_D(playersId,scheduleOtherName,playersFinishDate,userId) " +
    //   "VALUES ('243141','12424','2108-11-28 08:12','123458');",[]).then(data=>{}).then(data=>{
    //     console.log(data);
    // }).catch(e=>{
    //     console.log(e);
    // })

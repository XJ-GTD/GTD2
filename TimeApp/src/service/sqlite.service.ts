...
async createTable() {
  ...
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_ACCOUNT(ACCOUNT_MOBILE VARCHAR(20) PRIMARY KEY, ' +
  ...
  // })
  // //创建用户基本信息表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_A(userId VARCHAR(100) PRIMARY KEY, ' +
  ...
  //   'userType VARCHAR(2),' +
  //   'userToken VARCHAR(200))').catch(e=>{
  //   console.log('GTD_A:'+e.toString());
  // })
  // //创建日程表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_C(scheduleId VARCHAR(64) PRIMARY KEY, ' +
  ...
  //
  // //创建日程参与人表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_D(playersId VARCHAR(64) PRIMARY KEY, ' +
  ...
  //   console.log('GTD_ACCOUNT:'+e.toString());
  // })
  // this.importSqlToDb("select substr(playersFinishDate,1,10) finishDate,count(*) numL from GTD_D " +
  ...
  // })
  // //联系人表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_B(bpkId VARCHAR(64) PRIMARY KEY, ' +
  ...
  // })
  // //标签表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_F(labelId VARCHAR(64) PRIMARY KEY, ' +
  ...
  //
  // // 提醒时间表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_E(remindId VARCHAR(64) PRIMARY KEY, ' +
  //   'playersId VARCHAR(100),' +
  //   'remindDate VARCHAR(20)').catch(e=>{
  //   console.log('GTD_E:'+e.toString());
  // })
  // // message表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_H(messageId VARCHAR(64) PRIMARY KEY, ' +
  //   'messageName VARCHAR(100),' +
  //   'messageType VARCHAR(20)').catch(e=>{
  //   console.log('GTD_H:'+e.toString());
  // })
  // // 系统设置表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_G(systemId VARCHAR(64) PRIMARY KEY, ' +
  ...
  //
  // // 字典类型表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_X(dictValue VARCHAR(64) PRIMARY KEY, ' +
  //   'dictName VARCHAR(100)').catch(e=>{
  //   console.log('GTD_H:'+e.toString());
  // })
  // // 字典数据表
  // this.importSqlToDb('CREATE TABLE IF NOT EXISTS GTD_Y(dictValue VARCHAR(64) not null, ' +
  //   'dictDataName VARCHAR(100),dictDataValue VARCHAR(20) not null').catch(e=>{
  //   console.log('GTD_Y:'+e.toString());
  // })
  // await this.importSqlToDb('CREATE TABLE IF NOT EXISTS remindMaster(remind_id INTEGER PRIMARY KEY ' +

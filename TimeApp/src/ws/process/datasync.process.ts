            ...
            if (datatype == "Plan") {
              for (let plan of typeclassundel) {
                ...
                typeclassundel.forEach((planitem) => {
                  this.tellyouService.tellyou({id: planitem.jti, idtype: TellyouIdType.PlanItem, tellType: TellyouType.default});
                });
            } else if (datatype == "Agenda") {
              ...
              typeclassundel.forEach((agenda) => {
                this.tellyouService.tellyou({id: agenda.evi, idtype: TellyouIdType.Agenda, tellType: TellyouType.default});
              });
            } else if (datatype == "Memo") {

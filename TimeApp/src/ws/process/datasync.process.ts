          ...
          if (typeclassundel && typeclassundel.length > 0) {
            ...
            if (datatype == "Plan") {
              ...
              typeclassundel.forEach((annotation) => {
                this.tellyouService.tellyou4invsited(generateTellYouBase({id: annotation.obi+annotation.dt, dataid: annotation.ati, idtype: TellyouIdType.Agenda, tellType: TellyouType.default}));
              });
            } else if (datatype == "Grouper") {

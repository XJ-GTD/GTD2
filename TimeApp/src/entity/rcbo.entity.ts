...
export class RcboEntity {
   ...
   * @private
   */
  private _csq:string = 'CREATE TABLE IF NOT EXISTS GTD_C_BO(sI VARCHAR(100) PRIMARY KEY,' +
  ...
  private _drsq:string="DROP TABLE IF EXISTS GTD_C_BO;"

  private _isq:string;
  private _usq:string;
  private _dsq:string;
  //查询单个
  private _qosq:string = 'select * from GTD_C_BO where sI=' + this._sI;
  ...
  get dsq(): string {
    let sql='DELETE FROM GTD_C_BO WHERE 1=1 ';
    if(this._sI!=null){

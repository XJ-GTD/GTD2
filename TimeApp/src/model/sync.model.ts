...
export class SyncModel {
  ...
  private _action: number; //执行类型0添加或更新，1删除
  ...
  private _csq:string = 'CREATE TABLE IF NOT EXISTS GTD_S_Y(id INTEGER PRIMARY KEY AUTOINCREMENT,' +
                          'tableName VARCHAR(100) NOT NULL,action INTEGER,tableA VARCHAR(100),tableB VARCHAR(100),' +
  ...
  private _drsq:string="DROP TABLE IF EXISTS GTD_Y;"

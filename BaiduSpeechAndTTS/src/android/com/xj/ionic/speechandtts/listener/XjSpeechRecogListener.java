...
public class XjSpeechRecogListener extends StatusRecogListener {
    ...
    private static final String TAG = "XjSpeechRecogListener";

    public XjSpeechRecogListener(CallbackContext callbackContext){

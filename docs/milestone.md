...
2. 通知与提醒
    ...
    *通知* 为无精确时效要求的信息传达，用户可以在发生前或者发生后再收到; *提醒* 为有精确时效要求的信息传达，用户只有在发生时收到。
    ...
    | | 时间线 | 用户A | 用户B |
    |-|:-:|:-:|:-:|
    |1|第一天 上午|创建日程 __*明天下午三点开项目总结会*__| |
    |2|第一天 上午|设置 __*提前10分钟提醒*__| |
    |3|第一天 上午|邀请 __*用户B*__ 参加| |
    |4|第一天 上午/下午||收到 __*用户A*__ __*明天下午三点开项目总结会*__ 通知|
    |5|第一天 上午/下午||接受邀请|
    |6|第二天 上午|追加设置 __*提前30分钟提醒*__||
    |7|第二天 下午两点半|收到 __*下午三点开项目总结会通知+提醒*__|收到 __*下午三点开项目总结会通知+提醒*__|
    |8|第二天 下午两点五十分|收到 __*下午三点开项目总结会通知+提醒*__|收到 __*下午三点开项目总结会通知+提醒*__|

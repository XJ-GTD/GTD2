...
6. <a name="task-anchor-12">便捷操作</a>
    ...
    |4|指令||打开新消息提醒|^0.3.6||
    |5|内容|日程/任务<br/>重复设置|每周三重复|^0.3.8||
    |6|内容|日程/任务<br/>重复设置|到9月底为止|^0.3.8||
    |7|内容|日程/任务<br/>地址设置|在北京喜玛拉雅酒店|^0.3.8||
    |8|内容|日程/任务<br/>提醒设置|提前1天提醒我|^0.3.8||
    |9|内容|日程/任务<br/>提醒设置|当天没有完成前每隔半个小时提醒一次|^0.3.8||
